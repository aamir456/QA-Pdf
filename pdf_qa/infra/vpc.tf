...
# Public subnets host the ALB; private subnets host EKS nodes (no direct
# internet access — NAT gateway provides egress only).
# ---------------------------------------------------------------------------
...
resource "aws_subnet" "public" {
  ...
  tags = {
    ...
    "kubernetes.io/cluster/${var.project_prefix}-cluster"  = "shared"
  }
}
...
# Single NAT gateway (cost-optimised for a portfolio project).
# Production: one per AZ for HA.
